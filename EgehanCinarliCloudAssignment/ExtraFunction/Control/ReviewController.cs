...
namespace ExtraFunction.Control
{
    public class ReviewController
    {
        ...
        public async Task<HttpResponseData> CreateProduct([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "product/create/{productId:Guid}")] HttpRequestData req, Guid productId)
        {
